    ...
    <div className="total">
      <div className="title">
        ...
        <ul className="info">
          ...
          <p>
            적립<span className="point">{detailInfo.point}p</span>
          </p>
          <p>
            배송정보
          ...
          <p>
            리뷰평점<span className="Review">{detailInfo.score ? detailInfo.score : "0"}</span>
          </p>
        </ul>
        <div></div>
      </div>
      ...
      <div className="introdetail" id="intro-detail">
        <img
